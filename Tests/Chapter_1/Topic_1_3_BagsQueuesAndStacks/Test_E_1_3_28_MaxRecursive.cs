...
{
    [TestFixture]
    public class Test_E_1_3_28_MaxRecursive
    {
        [Test]
        public void Smoke()
        {
            ...
            Assert.AreEqual(3, new E_1_3_28_MaxRecursive().Solution(firstNode));
        }
        
        [Test]
        public void Empty()
        {
            Assert.AreEqual(0, new E_1_3_28_MaxRecursive().Solution(null));
        }
    }
}