...
{
    [TestFixture]
    public class Test_E_1_3_22_RemoveAfter
    {
        [Test]
        public void Smoke()
        {
            ...
            new E_1_3_22_RemoveAfter().Solution(node1);
            Assert.AreEqual(3, node1.Next.Value);

            node1.Next = node2;
            node2.Next = node3;
            
            new E_1_3_22_RemoveAfter().Solution(node2);
            ...
            new E_1_3_22_RemoveAfter().Solution(node3);
        }
    }
}